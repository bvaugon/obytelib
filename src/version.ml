...
let versions = [ V008; V010; V011; V022; V023; V025; V026; V027; V028; V029; V030; V031 ]

let to_string v = match v with
  | V008 -> "008" | V010 -> "010" | V011 -> "011" | V022 -> "022"
  | V023 -> "023" | V025 -> "025" | V026 -> "026" | V027 -> "027"
  | V028 -> "028" | V029 -> "029" | V030 -> "030" | V031 -> "031"
